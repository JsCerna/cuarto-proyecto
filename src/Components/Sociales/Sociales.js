  ...
  return (
    ...
    <article className='planilla'>
        ...
        <Carousel>
          ...
          <Carousel.Item>
            <img src="https://i.ibb.co/Q6sjLhp/IMG-7031.jpg" className="d-block w-100" alt="..." height={ 420 } />
          </Carousel.Item>
          <Carousel.Item>
            <img src="https://i.ibb.co/PY8X615/IMG-7030.jpg" className="d-block w-100" alt="..." height={ 420 } />
          </Carousel.Item>
        </Carousel>
      </Container>
      </article>
      ...
      <Container id='carrusel-container'>
        <Carousel>
          ...
          <Carousel.Item>
            <img src="https://i.ibb.co/0y36Yk6/IMG-7044.jpg" className="d-block w-100" alt="..." height={ 420 } />
          </Carousel.Item>
          <Carousel.Item>
            <img src="https://i.ibb.co/QNhBhvk/IMG-7034.jpg" className="d-block w-100" alt="..." height={ 420 } />
          </Carousel.Item>
        </Carousel>
      </Container>
      </article>
